...
//
// Pure arithmetic (Borkowski's algorithm), verified against the platform's own
// `Intl` Persian calendar (`fa-IR-u-ca-persian`) for every date used in this file's
// tests — no external dependency needed.
