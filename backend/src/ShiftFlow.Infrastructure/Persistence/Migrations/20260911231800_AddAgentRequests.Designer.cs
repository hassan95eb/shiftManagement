...
namespace ShiftFlow.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260911231800_AddAgentRequests")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShiftFlow.Domain.Entities.AgentRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CallAgentId", "RequestType", "Status")
                        .HasDatabaseName("IX_AgentRequests_CallAgent_Type_Status");

                    b.ToTable("AgentRequests", null, t =>
                        {
                            t.HasCheckConstraint("CK_AgentRequests_Range", "[EndUtc] > [StartUtc]");

                            t.HasCheckConstraint("CK_AgentRequests_RequestType", "[RequestType] IN ('Leave', 'Downtime')");

                            t.HasCheckConstraint("CK_AgentRequests_Status", "[Status] IN ('Pending', 'Approved', 'Rejected')");
                        });
                });
            ...
            modelBuilder.Entity("ShiftFlow.Domain.Entities.User", b =>
                {
                    ...
                    b.Navigation("DecidedAgentRequests");
